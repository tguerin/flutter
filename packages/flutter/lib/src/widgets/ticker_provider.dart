...
class TickerMode extends StatefulWidget {
  ...
  /// ```
  @Deprecated('Use TickerMode.valuesOf to get both enabled and forceFrames.')
  ...
  @Deprecated('Use TickerMode.getValuesNotifier to get both enabled and forceFrames.')
  ...
  static ValueListenable<TickerModeData> getValuesNotifier(BuildContext context) {
    final _EffectiveTickerMode? widget = context
        .getInheritedWidgetOfExactType<_EffectiveTickerMode>();
    return widget?.valuesNotifier ?? const _ConstantTickerModeDataListenable(
      TickerModeData(enabled: true, forceFrames: false),
    );
  }
...
class _TickerModeState extends State<TickerMode> {
  ...
  final ValueNotifier<TickerModeData> _effectiveValues =
      ValueNotifier<TickerModeData>(const TickerModeData(enabled: true, forceFrames: false));
