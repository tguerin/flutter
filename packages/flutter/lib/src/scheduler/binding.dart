...
mixin SchedulerBinding on BindingBase {
  ...
  bool get framesEnabled {
    // Never enable frames when detached or if the lifecycle state is not set, even if forced
    if (_lifecycleState == null || _lifecycleState == AppLifecycleState.detached) {
      return false;
    }
